...
* a <tt>textType</tt>.
*/
public class DiskTextCache extends AbstractTextCache
{
    //////////////////////
    // Instance variables:
    //////////////////////
    ...
    */
    public DiskTextCache (String directoryName) throws MGIException
    {
    ...
    */
	...
	try
	{
	    BufferedReader inFile = new BufferedReader(new FileReader(entry));
